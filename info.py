...
USERNAME = environ.get('USERNAME', "https://telegram.me/eren645")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001648037641').split()]
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002793834729'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002610557165')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002824228432'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002825123866')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002805287537'))
